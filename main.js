...
function buyUpg1p0() {
  if (currency0 >= upg1p0Price) {
    ...
    updateCurrency0Display();
    document.getElementById("upg1p0Button").textContent =
      "Double your number per click. Costs " + upg1p0Price;
    document.getElementById("numberIncreaseButton").textContent =
      "Increase your number by " + currency0Increase;
  }
}
function buyUpg2p0() {
  if (currency0 >= upg2p0Price) {
    ...
    updateCurrency0Display();
    document.getElementById("upg2p0Button").textContent =
      "Multiply your number per click by 2.5. Costs " + upg2p0Price;
    currency0Increase *= 2.5;
    document.getElementById("numberIncreaseButton").textContent =
      "Increase your number by " + currency0Increase;
  }
}
